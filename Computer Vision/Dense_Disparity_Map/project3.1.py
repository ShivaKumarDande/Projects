...
def harris_corner_alg(image):
    ...
    prewitt_X = np.array([[-1, -2, -1], [0, 0, 0], [1, 2, 1]])
    prewitt_Y = np.array([[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]])
    
    Ix = convolve2d(gray_image, prewitt_X, mode='same')
    Iy = convolve2d(gray_image, prewitt_Y, mode='same')
...
# Usage example:
path = "C:/Users/Shiva Kumar Dande/Desktop/Semester 2/CV_Project/image-3.jpeg"
image1 = imread(path)
print(image1.shape)
path = "C:/Users/Shiva Kumar Dande/Desktop/Semester 2/CV_Project/image-4.jpeg"
image2 = imread(path)
